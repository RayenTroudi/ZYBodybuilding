  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredExercises.map(exercise => (
            <div
              ...
              className="bg-neutral-800 rounded-xl border border-neutral-700 p-4 hover:border-red-500/50 cursor-pointer transition-all hover:shadow-lg hover:shadow-red-500/10"
            >
      ...
      {selectedExercise && (
        ...
        >
          <div
            className="bg-neutral-800 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-neutral-700"
