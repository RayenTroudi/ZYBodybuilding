...
export const metadata = {
  title: 'Gym Hammamet Tunisia — ZY Bodybuilding | Best Gym near Hammamet',
  description: 'Looking for a gym near Hammamet, Tunisia? ZY Bodybuilding in Mrezga, Nabeul is the closest full-service gym. Weightlifting, fitness classes, personal coaching. Call +216 58 800 554.',
  keywords: [
    'gym hammamet', 'best gym in hammamet', 'gym near hammamet tunisia',
    'fitness center hammamet', 'bodybuilding gym hammamet', 'fitness club hammamet',
    'gym hammamet tunisia', 'workout hammamet', 'personal trainer hammamet',
    'gym membership hammamet', 'fitness hammamet tunisia',
  ],
  alternates: {
    canonical: 'https://www.zybodybuilding.space/en/gym-hammamet',
    languages: {
  ...
  openGraph: {
    title: 'Gym Hammamet Tunisia — ZY Bodybuilding | Best Gym near Hammamet',
    description: 'The best gym near Hammamet, Tunisia — ZY Bodybuilding in Mrezga, Nabeul. Weightlifting, fitness, group classes, certified coaches. Join us today.',
    url: 'https://www.zybodybuilding.space/en/gym-hammamet',
    type: 'website',
    locale: 'en_US',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'ZY Bodybuilding — Best Gym near Hammamet, Mrezga, Nabeul, Tunisia',
      },
    ],
  },
};
...
const localJsonLd = [
  {
    ...
    '@type': 'WebPage',
    '@id': 'https://www.zybodybuilding.space/en/gym-hammamet',
    name: 'Gym Hammamet Tunisia — ZY Bodybuilding',
    description: 'English page for ZY Bodybuilding — the closest gym to Hammamet, located in Mrezga, Nabeul, Tunisia.',
    url: 'https://www.zybodybuilding.space/en/gym-hammamet',
    inLanguage: 'en',
    about: {
      '@type': 'HealthClub',
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Gym Hammamet', item: 'https://www.zybodybuilding.space/en/gym-hammamet' },
      ],
    },
  },
  {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ZY Bodybuilding in Mrezga, Nabeul is the closest and best-equipped gym to Hammamet, Tunisia. We offer weightlifting, fitness classes, group courses, and personal coaching just minutes from Hammamet.',
        },
      },
      {
        '@type': 'Question',
        name: 'How far is ZY Bodybuilding from Hammamet?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ZY Bodybuilding is located in Mrezga, Nabeul — just a few minutes by car from Hammamet. Search "ZY Bodybuilding Mrezga" on Google Maps for directions.',
        },
      },
      {
        '@type': 'Question',
        name: 'What gym facilities are available near Hammamet Tunisia?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ZY Bodybuilding near Hammamet offers: full weightlifting area, cardio equipment, group fitness classes, certified personal trainers, and a nutrition shop. State-of-the-art facilities in Mrezga, Nabeul.',
        },
      },
      {
        '@type': 'Question',
        name: 'How do I join ZY Bodybuilding near Hammamet?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Register online at zybodybuilding.space, WhatsApp us at +216 58 800 554, or visit us directly in Mrezga, Nabeul — just minutes from Hammamet.',
        },
      },
    ],
  },
...
const services = [
  { title: 'Weightlifting & Bodybuilding', desc: 'Professional weightlifting area with Olympic bars, free weights, guided machines, and cables. The complete gym experience near Hammamet.', icon: '💪' },
...
const faqs = [
  {
    q: 'What is the best gym near Hammamet Tunisia?',
    a: 'ZY Bodybuilding in Mrezga, Nabeul is the closest and best-equipped gym to Hammamet. We offer weightlifting, fitness classes, personal coaching, and state-of-the-art equipment just minutes from Hammamet.',
  },
  {
    q: 'How far is ZY Bodybuilding from Hammamet?',
    a: 'ZY Bodybuilding is located in Mrezga, Nabeul — just a few minutes by car from Hammamet. Search "ZY Bodybuilding Mrezga" on Google Maps for turn-by-turn directions.',
  },
  {
  ...
  {
    q: 'Are personal trainers available near Hammamet?',
    a: 'Yes! Our certified coaches near Hammamet create fully personalized training and nutrition programs based on your specific goals — weight loss, muscle gain, strength, or general fitness.',
  },
];

export default function GymHammametEnPage() {
  return (
    <>
      ...
      <main className="bg-black text-white">
        ...
        <section className="relative py-24 px-6 lg:px-16 text-center overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
              <span className="text-red-600">Gym near Hammamet</span>
              <br />
            ...
            <p className="text-lg sm:text-xl text-neutral-300 max-w-2xl mx-auto">
              The <strong className="text-white">best gym near Hammamet, Tunisia</strong> — ZY Bodybuilding in Mrezga, Nabeul.
            ...
            <p className="text-neutral-600 text-xs">
              Also available in:{' '}
              <Link href="/gym-hammamet" className="text-red-600 hover:underline">Français</Link>
            </p>
          </div>
        </section>
        ...
        <section className="py-16 px-6 lg:px-16 bg-neutral-950">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4">
              Why Choose <span className="text-red-600">ZY Bodybuilding</span> near Hammamet?
            </h2>
            <p className="text-neutral-400 text-center text-lg mb-12 max-w-2xl mx-auto">
              Everything you need to reach your fitness goals, just minutes from Hammamet, Tunisia.
            </p>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-4xl font-bold">
                The <span className="text-red-600">Closest Full Gym</span> to Hammamet
              </h2>
              <p className="text-neutral-300 leading-relaxed">
                Located in <strong>Mrezga, Nabeul</strong>, ZY Bodybuilding is just a few minutes from{' '}
                <strong>Hammamet</strong> — making it the most accessible professional gym for residents
                of Hammamet, Hammamet Nord, and the surrounding region.
              </p>
              <p className="text-neutral-300 leading-relaxed">
                Whether you want to build muscle, lose weight, improve your fitness, or train for sport,
                our gym near Hammamet has everything: premium equipment, certified coaches, and a
            ...
            <div className="space-y-4">
              <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 space-y-4">
                ...
                <div className="space-y-3 text-neutral-300 text-sm">
                  ...
                  <p><strong className="text-white">Distance:</strong> A few minutes from Hammamet</p>
                  <p>
              ...
              >
                📍 Get Directions from Hammamet — Google Maps
              </a>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-6 lg:px-16 bg-neutral-950">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4">
              FAQ — <span className="text-red-600">Gym near Hammamet</span>
            </h2>
            <p className="text-neutral-400 text-center mb-10">
              Everything you need to know about ZY Bodybuilding, the best gym near Hammamet, Tunisia.
            </p>
            <div className="space-y-4">
              {faqs.map((faq, i) => (
                <details
        ...
        <section className="py-16 px-6 lg:px-16 text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            <h2 className="text-3xl sm:text-4xl font-bold">
              Ready to join the best <span className="text-red-600">gym near Hammamet</span>?
            </h2>
            <p className="text-neutral-400 text-lg">
              Join ZY Bodybuilding in Mrezga — minutes from Hammamet — and start your transformation
            ...
            <p className="text-neutral-600 text-sm">
              ZY Bodybuilding — Mrezga, Nabeul 8000, Tunisia · Minutes from Hammamet
            </p>
          </div>
        </section>
